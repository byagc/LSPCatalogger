...
type
  ...
  public     //Atributos y sus propiedades de acceso
    ...
    tkFuncoes : TSynHighlighterAttributes;
    tkTipo :    TSynHighlighterAttributes;
    ...
    tnFuncoes  : integer;  //id para los símbolos
...
begin
  ...
  //tkSymbol.Foreground := clFuchsia;

  tkFuncoes := NewTokAttrib('Funcoes', tnFuncoes);   //atributo de símbolos
  tkFuncoes.Foreground := $00800080;
  tkFuncoes.Style := [fsBold];
  //tkFuncoes.Background := clGray;

  tkTipo := NewTokAttrib('Tipo', tnFuncoes);   //atributo de símbolos
  tkTipo.Foreground := clBlack;
  tkTipo.Style := [fsBold];
  //tkTipo.Background := clGray;
